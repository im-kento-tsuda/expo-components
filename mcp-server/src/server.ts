...
export async function createServer() {
  ...
  server.tool(
    "list_components",
    "Get a list of all available expo-components. Optionally filter by category.",
    {
      category: z
        .enum([
          "form-inputs",
        ...
        .optional()
        .describe(
          "Filter by category: form-inputs, layout, data-display, feedback, navigation"
        ),
    },
    async ({ category }) => {
      const list = category
        ? getComponentsByCategory(category as CategoryId)
        : components;
  ...
  server.tool(
    "get_component",
    "Get detailed information about a specific component including props, examples, and usage notes.",
    {
  ...
  server.tool(
    "search_components",
    "Search for components by keyword. Searches in name, description, and props.",
    {
